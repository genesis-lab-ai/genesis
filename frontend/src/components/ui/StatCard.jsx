...
export default function StatCard({ label, value, unit, trend, trendValue, icon: Icon }) {
  return (
    <div className="glass relative rounded-xl border border-border bg-surface p-3.5 shadow-lg shadow-black/20 overflow-hidden group hover:border-white/20 transition-colors">
      <div
